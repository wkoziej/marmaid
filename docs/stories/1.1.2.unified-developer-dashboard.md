...
- **Git Information**: Build-time injection working via Vite with __GIT_INFO__ global
...
- **Environment Variables**: Tests should handle different VITE_* configurations
- **Global Variables**: Mock __GIT_INFO__ appropriately for consistent test results
